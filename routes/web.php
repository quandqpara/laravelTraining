...
Route::get('teams/search', [TeamsController::class, 'index'])->name('team.search')->middleware('check.admin');;
...
Route::get('employees/search', [employeesController::class, 'search'])->name('employee.search')->middleware('check.admin');;
...
Route::post('employees/create', [employeesController::class, 'createConfirm'])->name('employee.createConfirm')->middleware('check.admin');;
Route::get('employees/create/{confirm}', [employeesController::class, 'create'])->name('employee.create')->middleware('check.admin');;
...
Route::get('employees/edit/{confirm}', [employeesController::class, 'edit'])->name('employee.edit')->middleware('check.admin');;
